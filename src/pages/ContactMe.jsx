        ...
        <div className='px-8 text-stone-50'>
            ...
            <div className='grid grid-cols-2 p-16'>
                <div className='md:w-[35rem] justify-self-center'>
                    ...
                    <button className='bg-blue-600 text-stone-50 p-2 px-4 hover:bg-cyan-600 rounded-lg'>Submit</button>
                </div>
                <div className='my-4 justify-self-center self-center'>
                    ...
                    <a href='https://www.linkedin.com/in/yogeshr6/' target='_blank'><i class='fa-brands fa-linkedin fa-5x px-8 hover:text-[#0077B5] hover:scale-110'></i></a>
